      ...
      <body>
        ...
        <div id="video-container">
         <div class="overlay-text">SPEEDxSHIVA</div>
          ...
          <select id="quality">
            <option value="https://smart.bengaldigital.live/T-Sports_HD/tracks-v1a1/mono.m3u8">240P</option>
            <option value="https://smart.bengaldigital.live/T-Sports_HD/tracks-v1a1/mono.m3u8">360P</option>
            <option value="https://top1-cdnnew.koskoros.ru/top1-cdn/7UHvIS62zx/mono.m3u8">480P</option>
            <option value="https://smart.bengaldigital.live/T-Sports_HD/tracks-v1a1/mono.m3u8">540P</option>
            <option value="https://smart.bengaldigital.live/T-Sports_HD/tracks-v1a1/mono.m3u8">Full HD</option>
          </select>
        </div>
        <div class="telegram">
