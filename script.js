      ...
      <body>
        ...
        <div id="video-container">
         <div class="overlay-text">SPEEDxSHIVA</div>
          ...
          <select id="quality">
            <option value="https://myctxa.temycssme.wiki/720p.m3u8">240P</option>
            <option value="https://myctxa.temycssme.wiki/720p.m3u8">360P</option>
            <option value="https://myctxa.temycssme.wiki/720p.m3u8">480P</option>
            <option value="https://myctxa.temycssme.wiki/720p.m3u8">540P</option>
            <option value="https://myctxa.temycssme.wiki/720p.m3u8">Full HD</option>
          </select>
        </div>
        <div class="telegram">
